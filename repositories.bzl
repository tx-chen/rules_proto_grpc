...
def rules_proto_grpc_repos(**kwargs):
    ...
    http_archive(
        name = "protoc_linux",
        sha256 = "acf79987ffaac565f24a59b738f932377c783fb9615347fd6fade5dadd863242",
        urls = [
            "https://github.com/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-linux-x86_64.zip",
            "https://ghproxy.com/https://github.com/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-linux-x86_64.zip",
            "https://download.fastgit.org/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-linux-x86_64.zip",
        ],
    ...
    http_archive(
        name = "protoc_macos",
        sha256 = "ed3a657ea591eb7b314b81a01aac55e2fbb1cf82966bff1603de0bbae80cb9b9",
        urls = [
            "https://github.com/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-osx-x86_64.zip",
            "https://ghproxy.com/https://github.com/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-osx-x86_64.zip",
            "https://download.fastgit.org/protocolbuffers/protobuf/releases/download/v3.15.3/protoc-3.15.3-osx-x86_64.zip",
        ],
        build_file_content = """exports_files(["bin/protoc"], visibility = ["//visibility:public"])""",
    )
